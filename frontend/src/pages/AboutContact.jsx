    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                {/* About Section */}
                <div>
                    <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">About LuminaReads</h1>
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                        Founded in 2026, LuminaReads has grown from a small local bookshop to a premier online destination for literature lovers worldwide. We believe that the right book can change a life, spark a movement, or simply provide a perfect escape.
                    </p>
                ...
                <div className="bg-white dark:bg-dark-surface p-10 rounded-3xl shadow-lg border border-gray-100 dark:border-dark-border">
                    ...
                    <div className="mt-10 pt-8 border-t border-gray-100 dark:border-dark-border grid grid-cols-1 sm:grid-cols-3 gap-6">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <span className="text-xs text-gray-500 mt-1">support@luminareads.com</span>
                        </div>
                    </div>
                </div>
            </div>
