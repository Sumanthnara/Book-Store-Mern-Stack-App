            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        <Link to="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-bold text-2xl tracking-tight text-gray-900 dark:text-white">Lumina<span className="text-primary-600">Reads</span></span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <span>support@luminareads.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-200 dark:border-dark-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-400 text-sm">
                        &copy; {new Date().getFullYear()} LuminaReads. All rights reserved.
                    </p>
